...
console.log(`This house at address ${listing1.address} is owned by ${listing1.currentOwner}`);
...
const realtorFees = (listing) => {
  ...
  const formattedPrice = listing.price.replace(/[,$]/g, "");

  const priceOption1 = (formattedPrice * .02);
  const priceOption2 = (formattedPrice * .025);

  return(formattedPrice > 450000 ? priceOption1 : priceOption2);
}

//const test = realtorFees(listings[]);
//console.log(test);
//const num1 = "$2,000";
//const formattedPrice = num1.replace(/$|,/g, "");
